...
I think one of my biggest findings is that the top lobbyists belong to a handful of the same lobbying firm, which isn't entirely surprising. Similar aspects relevant in federal lobbying is prevalent in Maryland's lobbying data. Those with personal connections after working in Congress and the Maryland legislature are the most popular lobbyists. OpenSecrets' refers to this as the Revolving Door, where former staffers and political insiders leverage their work relationships in their lobbying endeavors.  
