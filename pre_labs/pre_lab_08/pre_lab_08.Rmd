...
```{r echo=FALSE}
census_api_key("0a53a7462b879050ca5ae511611822015ba9a811", install=TRUE)
...
**Answer** I'm not sure I know how to read this chart correctly. But if I'm reading it right, I do think the difference between Calvert and Montgomery are significant. Calvert's bar is much wider, which (I think?) indicates a higher margin of error. 
...
Which counties saw their median incomes fall from 2010-2019? Is the change outside the margin of error for both?

**Answer** Caroline and Somerset saw their median incomes fall from 2010-2019. 
...
**Answer** I don't think I understand this question. 21723 and 21841 are among the group that has estimated median household incomes of less than $50,000.
