...
**Answer** I see a screenshot of different file types with the same variable name. 
...
**Answer** Seeing a peek of the shp file. Columns include: OBJECTID, ID, NAME, ADDRESS, CITY, STATE, ZIP, ZIP4, TELEPHONE, TYPE, STATUS, POPULATION, COUNTY, COUNTYFIPS, COUNTRY, LATITUDE, LONGITUDE, NAICS_CODE, NAICS_DESC, SOURCE, SOURCEDATE,VAL_METHOD, VAL_DATE, WEBSITE, STATE_ID, ALT_NAME, ST_FIPS, OWNER, TTL_STAFF, BEDS, TRAUMA, HELIPAD, and geometry.             
...
**Answer** This looks like a tibble, but it's not. The data includes hospital names and location information. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A tibble with 7 rows and 3 columns with the type of medical care, the count of each care and geometry info for each. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Another tibble-like result that includes hospital addresses and other info for general acute care services. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is a plot chart with geography degrees on the x and y axis. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I get this message: "To enable 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A tibble with 3,233 rows and 18 columns. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Creates a dataframe with 18 columns and 24 rows. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is a map of md counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** there is a map of MD counties with dots plotted in various counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is a map with various colored dots plotted. there is also a color key
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Another tibble like result that isolates general acute care data in MD
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Tibble with 2 columns (county and # of total beds) with 22 rows
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** A tibble with 25 rows and 5 columns (geoid, name, variable, estimate and moe). 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** At first I got this error "Error: Your API call has errors. The API message returned is Sorry, the system is currently undergoing maintenance or is busy. Please try again later.." 

Ran the code again about two mins later and it ran succesfully. Seeing another tibble-like result pulling population data from each MD county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Another tibble with 22 rows and 2 columns (total beds and county)
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** I get this error "Error: Can't subset columns that don't exist. x Column `geometry` doesn't exist."

Ran the function again a few minutes later and it worked. Tibble-like result pulling geometry for MD counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Tibble-like result joining population data and geomerty data for MD counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Replaced n/a for queen anne's total bed with 0
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Adding beds per 100k column with values for accurate comparison between counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Map of MD counties. Each county box is filled with various shades of blue, depending on the number of beds per 100k. There is also a colored key.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** Same map but with different colors, now the shades range from orange to deep purple.
...
**Answer** Same map but two counties don't have data and are filled with gray instead. 
