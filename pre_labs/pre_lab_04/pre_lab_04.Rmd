...
**Answer** There are 195,869 rows in maryland_ppp. 
...
**Answer** The error says "Can't join on `x$zip` x `y$zip` because of incompatible types. ℹ `x$zip` is of type <character>>. ℹ `y$zip` is of type <double>>." I think it's because the values are different types and R can't mesh them together. 
...
**Answer** Some columns and rows have N/A in the value field. 
...
**Answer** Some rows still have N/A. 
...
**Answer** 44032 loans went to the population. The average amount was $53,836.46 and the median amount was $20,000. 	
...
**Answer** 11,3937 loans went to the population. The average amount was $88140.24 and the median amount was $20,833.
...
**Answer** Rural areas recieved 148 loans. The average amount was $44,328.87	and the median amount was $19,621. Urban areas received 43884 loans. The average amount was $53868.53 and the median amount was $20000. 
...
**Answer** The rural area received 18337 loans. The average was $73694.14 and the median amount $20833. The urban area received 95600. The average amount was $90911.14 and the median amount is $20833. 
