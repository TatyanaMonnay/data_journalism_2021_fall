...
**Answer** First thing I see is a bunch of links to a bunch of BlS data and it's followed by charts and explanation of the data. 
...
**Answer**I see a bunch of html code. 
...
**Answer** It looks like the code spit out the header and font type of the body text. 
...
**Answer** It looks like a chart but without lines. The column headers read 'name,' 'type' and 'value'.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** I see a bunch more code butt this time it's split up into sections. This might be a CSS style page? 
...
**Answer** This code created six tibbles with various values. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It looks the same but here is more text and more data. 
...
**Answer** In the expanded section, there is more data that includes the release date and conversion. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** In the expanded section, there is a sector and description column. 
...
**Answer** There is a tibble with two columns for sector and description. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** There are different charts going into more detail about employee data in the utility industry. 
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** The code spit out html code from the link we provided. 
...
**Answer** The code spit out more html code that inlcudes foot notes and captions. 
...
**Answer** The tibble is showing data series for June through September.
...
**Answer** Tibble only pulled data for the data series in June. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** There is employment data for the mining, quarrying, oil and gas industry.  
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** There is employment data for the construction industry.  
...
**Answer** It's a list of the values we provided. 
```{r}
...
**Answer** Nothing appears under the codeblock. 
```{r}
...
**Answer** I get this error: Error in sector_list : object 'sector_list' not found
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** I get this error: Error in print(sector_name) : object 'sector_name' not found
...
**Answer** It's a list of numbers in order from 1 to 10. 
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** The code produces a tibble with a sector and description. 
...
**Answer** The code produces an answer of 20.
...
**Answer** A list of numbers in order from 1 to 20. 
...
**Answer** The code procuded a tibble that shows employment data from June 2021. 
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** The code produces a tibble with the sector and description columns. 
```{r}
# Define url of page we want to scrape
...
**Answer** The code produces a tibble with the sector, description, url and path id columns.  
...
**Answer** The code produces 19 tibbles. 
...
**Answer** The code produces a list of row numbers and data.
```{r}
...
**Answer** The code produced 19 tibbles with employment data for each month. 
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** The code produced 19 tibbles with sector and employment information for June 2021. 
...
**Answer** The code produced a tibble with the sector and its corresponding description. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** The data on the page is about the mining, quarrying, oil and gas extraction industry. 
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** I see more data including an unemployment rate. 
...
**Answer** The code block produced a tibble with a sector, industry description and June 2021 employees. 
