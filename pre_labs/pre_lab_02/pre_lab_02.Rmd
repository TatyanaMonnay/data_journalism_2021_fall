...
**Answer** The first payroll percentage result is 469,800.00.
...
**Answer** There are 145 applications that meet that criteria. 
...
```
What is the number of applications that meet that criteria? Put your answer in the space below.
**Answer** The number of applicants is 54,321. 
...
**Answer** April saw the most applicants with 45,043 applications. 
