...
**Answer** One change that happened is that cities in the original column that were all uppercase changed to regular uppercase on the first letter and lowercase in the rest of the word. Another thing is the table is expanded to include more columns.  
...
**Answer** This new change includes the count of loans. This new change also excludes other column to just include city_clean, city and count. Another change is that the names of the city_clean and city columns are in alphabetical order. 
...
**Answer** I don't see much of a difference in the city names or the count or the order of each. 
