...
```{r, echo=FALSE}
knitr::include_graphics(rep("images:ppp_1.pdf"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(rep("images:ppp_2.pdf"))
```
...
```{r, echo=FALSE}
knitr::include_graphics(rep("images:ppp_3.pdf"))
```
