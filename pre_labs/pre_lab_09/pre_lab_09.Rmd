...
**Answer** We're making a new dataframe called maryland_ppp_top_counties using data from ppp_maryland. We are collecting county names and the total number of loans in each county. We're arranging the data from largest to smallest. We're selecting the first 10 rows in the new dataframe. We're viewing the tibble. 
...
**Answer** I see a blank white box. 
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** I see a bar graph with grey bars. The graph is measirng the the total number of loans for each county. 
...
**Answer** Same graph. The bars are set from smallest to largest. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The axises were flipped so that the countty names are on the y axis and are more readable. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The space between the county names and the bars are cleaner. 
...
**Answer** The background is a light blue and there are white lines in the chart. 
```{r}
maryland_ppp_top_counties %>%
  ggplot() +
  geom_bar(aes(x=reorder(project_county_name,total_loans), weight=total_loans)) +
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** There is a headline and source attribution. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There are dates for loan approval and the number of loans approved on that date in no particular order.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** I see a line graph chronicling the total loans approoval throughout 2020 and 2021. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Same graph as above but with more dates on the x axis and the dates are all bunched up. 
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** Same graph as above but dates are angled for better readability. 
```{r}
ppp_maryland_loans_by_date %>%
  ggplot() + 
  geom_line(aes(x=date_approved, y=total_loans)) + 
