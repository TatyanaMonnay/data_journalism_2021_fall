...
**Answer** The data frame has loaded and the typical output is below. The data frame popped up in another window. 
...
**Answer** There is one county missing but it has a total #. 
...
**Answer** I'm not sure. I think the filter could be targeting the N/As in the dataframe? 
...
**Answer** I'm still seeing N/As in the data frame in the date column. I'm not sure I really see a pattern right now.    
...
**Answer** It seems like vaccinations spiked after April 2021 in the summer. The chart is showing the evolution of vaccinations from Jan 2021 to Oct 2021. 
...
**Answer** "The number of people in Prince George's County fully vaccinated on December 02 NA by NA percent compared to the week before"
...
**Answer** The chart shows the number of positive covid cases in each MD county. 
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** Same chart as above but the y-axis values have changed and I don't really understand what they mean such as 1e+05 and 1e+03. 
...
**Answer** Getting an error here and can't continue. 
