...
wv_ppp <- readRDS("data/lab_11.rds")
...
mining_per_100k <- wv_pop %>% 
  left_join(mining_loans, by="project_county_name", "total_loans", "total_loan_amount") 
...
ggplot() + 
  geom_sf(data=wv_pop, aes(fill=miining_per_100k)) + 
  theme_minimal() +
