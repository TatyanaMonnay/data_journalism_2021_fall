...
maryland_ppp_with_naics <- maryland_ppp %>% left_join(naics_codes) %>% mutate(zip5 = str_sub(zip, 1, 5))
...
**A1** [write your answer here] The top 5 industries include taxi service, beauty salons, full-service restaurants, Offices of Real Estate Agents and Brokers and All Other Personal Services.
...
**A2** [write your answer here] The top 5 industries who received over $150k in loans are Full-Service Restaurants, New Car Dealers, Offices of Physicians (except Mental Health Specialists),Plumbing, Heating, and Air-Conditioning Contractors, Engineering Services. 	 	 	  
...
**A3** [write your answer here] The qualifying MD zipcode with the largest sum of PPP loans is $136,195,702.5.
...
**A4** [write your answer here] The MD zip code with the largest sum of loans with the qualifying population is 21046-1529	with $8,979,065.00. It's interesting that the zip code only received one loan. 
...
**A5** [write your answer here] It might be because the Asian population is in the minority of business owners in that zip code. 
...
**A6** [write your answer here] Not sure how to answer this question! Created a function to count the amount of loans in zip codes where the recipient was labeled as Asian. 
...
**A7** [write your answer here] 47 industries that recieved exactly one loan in the data. 
