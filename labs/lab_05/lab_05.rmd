...
naics_code <- read_csv('/Users/tatyanamonnay/Desktop/data_journalism_2021_fall/labs/lab_05/naics_codes.csv')

wv_population <- read_csv('/Users/tatyanamonnay/Desktop/data_journalism_2021_fall/labs/lab_05/wv_population_county.csv')

zip_loans <- read_csv('/Users/tatyanamonnay/Desktop/data_journalism_2021_fall/labs/lab_05/zip_25401_loan_sample.csv')
...
cleaned_zip_loans <- read_csv('/Users/tatyanamonnay/Desktop/data_journalism_2021_fall/labs/lab_05/cleaned_zip_25401_loan_sample-csv.csv')
...
**A1.**  126 E Burke St received the most loans. There were 3 loans at this street address. It's associated businesses are ABRAHAM ASHTON, BRIX27, LLC, DREW HOLDINGS LLC, HUB CO-OP LLC and RONIN PROPERTIES LLC. 
...
**A2.** It seems that the businesses are affiliated with the same group of people such as Abraham Ashton so it's not super suspicious that they all got loans granted, but it is strange that these businesses are all located in the same address unless this is a a broader office space utilized by these businesses. 
...
**A3.** The city with the highest number of loans was Martinsburg. 

```{r}


berkeley_loans <- read_csv('/Users/tatyanamonnay/Desktop/data_journalism_2021_fall/labs/lab_05/cleaned_city_ppp_loans.csv')
...
berkeley_loans %>%
  filter(county== 'Berkeley') %>%
  group_by(title) %>%
  summarise(count =n()) %>%
  arrange(desc(count)) 
                  
berkeley_loans %>% left_join(naics_code, by='naics_code') 
